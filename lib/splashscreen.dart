...
class _ProgressIndicatorState extends State<ProgressIndicator>
  ...
  void loadpref(BuildContext ctx) async {
    ...
    if (email.length > 5) {
      ...
      //
      loginUser("unregistered@cphotelbooking.com", "123456789", ctx);
    }
  }

  void loginUser(String email, String pass, BuildContext ctx) {
    http.post("https://yitengsze.com/hcpbs/php/login_user.php", body: {
      "email": email,
      "password": pass,
    })
      ...
      if (userdata[0] == "success") {
        ...
        Toast.show("Login as an unregistered account", context,
